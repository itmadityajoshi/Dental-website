          ...
          <section className="relative hidden overflow-hidden bg-slate-950 p-12 text-white lg:flex lg:flex-col lg:justify-between">
            <div>
              ...
              <p className="mt-6 max-w-md text-lg leading-relaxed text-slate-300">
                Sign in to manage your appointments, meet your care team, and
                keep your next visit on track.
              </p>
            </div>

            <p className="border-t border-slate-700 pt-6 text-sm text-slate-400">
              Personal care. Clear choices. Better visits.
            </p>
          </section>
            ...
            <div className="w-full max-w-md">
              <div className="mb-8">
                ...
                <p className="mt-2 text-slate-500">
                  Manage your appointments from one calm, simple place.
                </p>
              </div>
